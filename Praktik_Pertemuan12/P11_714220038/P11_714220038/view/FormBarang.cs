...
namespace P11_714220038.view
{
    public partial class FormBarang : Form
    {
        ...
        {
            if (string.IsNullOrEmpty(tb_NamaBarang.Text) || !tb_NamaBarang.Text.All(char.IsLetter) || string.IsNullOrEmpty(tbharga.Text) || !tbharga.Text.All(char.IsDigit))
            {
            ...
            else
            {
                ...
                m_barang.Nama_barang = tb_NamaBarang.Text;
        ...
        private void DataBarang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            tb_NamaBarang.Text = DataBarang.Rows[e.RowIndex].Cells[1].Value.ToString();
