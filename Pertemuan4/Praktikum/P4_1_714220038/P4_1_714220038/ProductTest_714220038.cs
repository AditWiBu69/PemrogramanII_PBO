...
{ 
     class ProductTest_714220038
    {
        static void Main(string[] args)
        {
            Book_714220038 product1 = new Book_714220038("Book", "C# Object Oriented Solution", "300");
            DVD_714220038 product2 = new DVD_714220038(" Eternal Sunshine Of The Spotless Mind", "145");
